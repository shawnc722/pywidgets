...
Before starting, we should make a `page.py` file for testing this (or add it to an existing one). If you'd rather skip creating one, you can download [`clock_test_page.py`](clock_test_page.py) (right click, 'save link as') and uncomment the palette lines if you want to change the colors.
